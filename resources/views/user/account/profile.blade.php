        ...
        <div class="container-fluid">
            ...
            <div class="row">
                ...
                <div class="col-lg-10 mx-auto">
                    ...
                    <a href="{{ route('user#homePage') }}" class="btn btn-dark"><i class="fas fa-arrow-left me-2"></i> Back</a>
                    ...
                    <div class="card mt-3">
                        ...
                        <div class="card-body">
                            ...
                            <div class="container p-4">
                                <form class="p-3" action="{{route('user#updateProfile',Auth::user()->id)}}" method="post" enctype="multipart/form-data">
                                    @csrf
                                            ...
                                            <div class="image mb-4">
                                                @if (Auth::user()->image === null)
                                                    @if (Auth::user()->gender == 'male')
                                                        <img src="{{ asset('storage/male.png')}}" class="contains w-100" alt=""/>
                                                    @else
                                                        <img src="{{ asset('storage/female.jpg')}}" class="contains w-100" alt=""/>
                                                    @endif
                                                @else
                                                    <img src="{{ asset('storage/'.Auth::user()->image) }}" class="w-100" alt="John Doe" />
                                                @endif
                                            </div>
